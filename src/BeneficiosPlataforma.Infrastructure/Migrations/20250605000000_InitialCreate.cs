        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MdmStatus = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MasterDataRegistry", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MasterDataRegistry_GlobalId",
                table: "MasterDataRegistry",
                column: "GlobalId");

            migrationBuilder.CreateIndex(
                name: "IX_MasterDataRegistry_TenantId_LocalId",
                table: "MasterDataRegistry",
